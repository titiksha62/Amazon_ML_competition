...
def extract_and_standardize_unit(text):
    ...
    if unit_type == 'weight':
        unit_value_std = value * CONVERSION_FACTORS['oz']
    elif unit_type == 'volume':
        unit_value_std = value * CONVERSION_FACTORS['fl oz']
...
# 🚨 CRITICAL FIX: DELETING THIS LINE TO AVOID DATA LEAKAGE.
...
# 🚨 CRITICAL FIX: REMOVING 'price_per_unit' from the output selection.
